...
public class PM_TreeWindowBase extends PM_TreeWindowDragAndDrop implements PM_Interface {
	
	
	// ==========================================================
	// Konstruktor
	// ==========================================================
	public PM_TreeWindowBase(PM_WindowBase windowBase) {	
		super(windowBase,  PM_TreeModelBase.getInstance(), null);  
	...
	protected void renderCell(JTree tree, DefaultMutableTreeNode node, DefaultTreeCellRenderer renderer )  {
		...
		if (o instanceof PM_SequenceBase) {
		      if (!PM_SequenceBase.getSequenceInAlbum().contains((PM_SequenceBase)o)) {
